"""
Django settings for laboratoire_bj project.
...
SECRET_KEY = 'django-insecure--%!@@4g5#88bq7=a-wpd+hv1)%#f(&_hk!#v%k(7#5hpr7adq1'
...
WSGI_APPLICATION = 'laboratoire_bj.wsgi.application'
